...
<div class="main-content">
    <section class="section">
        <div class="section-header  d-flex justify-content-between">
            <h1>All Category</h1>
            <a class="btn btn-primary" href="<?= ADMIN_URL ?>category-add.php">Add Category</a>
        </div>
                                            ...
                                            foreach ($result as $index => $row) { ?>
                                                <tr>
                                                    ...
                                                    <td class="pt_10 pb_10">
                                                        ...
                                                        <a href="<?= ADMIN_URL?>category-edit.php?id=<?=$row['id'];?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                        <a href="<?= ADMIN_URL?>category-delete.php?id=<?=$row['id'];?>" class="btn btn-danger" onClick="return confirm('Are you sure?');"><i class="fas fa-trash"></i></a>
                                                    </td>
