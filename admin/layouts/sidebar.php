<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?= ($current_page == 'category-view.php' || $current_page == 'label-view.php') ? 'active' : '' ?>">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="<?= ($current_page == 'label-view.php') ? 'active' : '' ?>"><a class="nav-link" href="<?=ADMIN_URL?>label-view.php"><i class="fas fa-angle-right"></i> Label</a></li>
