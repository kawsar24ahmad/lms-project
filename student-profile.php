...
try {
    if (isset($_POST['form_update'])) {
        ...
        $_SESSION['student']['zip_code'] = $_POST['zip_code'];
        ...
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
            ...
            if ($mime === "image/png" || $mime === "image/jpeg") {
                if (!empty($_SESSION['student']['photo'])) {
                ...
                if (move_uploaded_file($tmp_path, "uploads/" . $file_name)) {
                    ...
                    $statement->execute([$file_name, $_SESSION['student']['id']]);
                    $_SESSION['student']['photo'] = $file_name;
                } else {
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php else:?>
                                        <img src="<?= BASE_URL; ?>uploads/<?=$_SESSION['student']['photo']?>" alt="" class="user-photo">
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control" value="<?= $_SESSION['student']['name']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Email Address *</label>
                                    <div class="form-group">
                                        <input type="text" name="email" class="form-control" value="<?= $_SESSION['student']['email']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="country" class="form-control" value="<?= $_SESSION['student']['country']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="state" class="form-control" value="<?= $_SESSION['student']['state']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">City *</label>
                                    <div class="form-group">
                                        <input type="text" name="city" class="form-control" value="<?= $_SESSION['student']['city']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Zip Code *</label>
                                    <div class="form-group">
                                        <input type="text" name="zip_code" class="form-control" value="<?= $_SESSION['student']['zip_code']?>">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
